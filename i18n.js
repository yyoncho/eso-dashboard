...
(function () {
  ...
  const SUB = [
    ...
    [' търсене сред всички летни дни (юни–август) на 2022–2025 г. по най-близко едновременно съвпадение по дневно потребление (GWh) и нетен износ (GWh) спрямо избрания днешен ден — без филтър по въглища, за да не се изкриви резултатът. 14 август 2022 излезе на първо място сред августовските дни с чисти данни по комбинирана близост.',
     ' a search across every summer day (June–August) from 2022–2025 for the closest simultaneous match on daily consumption (GWh) and net export (GWh) to the chosen day today — no coal filter, so the result wasn\'t skewed. 14 August 2022 came out on top among August days with clean data by combined closeness.'],
