...
(function () {
  ...
  const SUB = [
    ...
    ['26 юни 2022 — енергийна криза', '26 June 2022 — energy crisis'],
    ...
    [' търсене сред всички летни дни (юни–август) на 2022–2025 г. по най-близко едновременно съвпадение по дневно потребление (GWh) и нетен износ (GWh) спрямо избрания днешен ден — без филтър по въглища, за да не се изкриви резултатът. 26 юни 2022 излезе на първо място по комбинирана близост.',
     ' a search across every summer day (June–August) from 2022–2025 for the closest simultaneous match on daily consumption (GWh) and net export (GWh) to the chosen day today — no coal filter, so the result wasn\'t skewed. 26 June 2022 came out on top by combined closeness.'],
